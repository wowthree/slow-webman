...
use app\admin\renders\Button;
use app\admin\renders\Dialog;
use app\admin\renders\CRUDTable;
use app\admin\renders\Operation;
use app\admin\renders\LinkAction;
use app\admin\renders\AjaxAction;
use app\admin\renders\OtherAction;
use app\admin\renders\DialogAction;
...
trait PageElement
{
    ...
    {
        $setting = app(AdminSettingService::class)->get('system_theme_setting');
